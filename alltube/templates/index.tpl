...
<main class="main">
    <div><img class="logo" src="https://cdn.earthroulette.com/viddl/viddll.png?w=350"
              alt="{$config->appName}"></div>
    <form action="{path_for name="info"}">
        <label class="labelurl" for="url">
            {t}Paste the video URL of your video (YouTube, Twitter, etc.){/t}
        </label>
        <div class="champs">
